...
import static com.codenvy.ide.ext.runner.client.tabs.properties.panel.common.Boot.IDE_OPENS;
import static com.codenvy.ide.ext.runner.client.tabs.properties.panel.common.Boot.RUNNER_START;
...
import static com.codenvy.ide.ext.runner.client.tabs.properties.panel.common.Shutdown.ALWAYS_ON;
import static com.codenvy.ide.ext.runner.client.tabs.properties.panel.common.Shutdown.BY_TIMEOUT;
...
public class PropertiesPanelViewImplTest {
    ...
    private void scopeShouldBeAdded() {
        for (Enum item : EnumSet.allOf(Scope.class)) {
    ...
    public void bootShouldBeReturned() {
        ...
        when(view.boot.getValue(1)).thenReturn(RUNNER_START.toString());

        assertThat(view.getBoot(), is(RUNNER_START));
    }

    @Test
    public void bootShouldBeSelected() {
        view.selectBoot(IDE_OPENS);

        verify(view.boot).setItemSelected(IDE_OPENS.ordinal(), true);
    }
